...
# This mkfiles.sh script file has been copied from the Input Output project and some small modifications have been made,

# See https://github.com/input-output-hk/cardano-node/blob/master/scripts/babbage/mkfiles.sh
...
cp configuration/cardano/alonzo-babbage-test-genesis.json "${ROOT}/genesis.alonzo.spec.json"
